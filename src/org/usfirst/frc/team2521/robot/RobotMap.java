...
public class RobotMap {
	...
	// Lidar
	// Lidar curve fitting was quadratic, so a, b, and c
	// are the coefficients
	public static final double LIDAR_A = 0.005184;
	public static final double LIDAR_B = -10.97;
	public static final double LIDAR_C = 7140;
